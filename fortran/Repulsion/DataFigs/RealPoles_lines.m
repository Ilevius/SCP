function RealPoles_lines(fname,key,f1,f2,nf)

% Real dispersion curves by lines
...
% Call example: RealPoles_lines('fs.dat',1,0,0.5,1)

% units for dimensionless plots
%f0 = 310;   % kHz 
%v0 = 3.1;   % km/s
%s0 = 1/v0; % s/km
%l0 = 10; % mm
