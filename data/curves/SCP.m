...
plot(data1(:,1), data1(:,2), mrk, data2(:,1), data2(:,2), mrk, data3(:,1), data3(:,2), mrk ...
    , data4(:,1), data4(:,2), mrk, data5(:,1), data5(:,2), mrk, data6(:,1), data6(:,2), mrk...
    , data7(:,1), data7(:,2), mrk, 'LineWidth', 2)
xlim([0 1.5]); ylim([0 5]);
